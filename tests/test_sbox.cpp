...
TEST(TestSBox, S1_ExhaustiveEnum) {
  for (uint8_t count = 0; count < 16; count++) {
    ...
    EXPECT_EQ(Sbox[0][1][count], SBox::apply(ival | 0x01, S1));
    EXPECT_EQ(Sbox[0][2][count], SBox::apply(ival | 0x20, S1));
    EXPECT_EQ(Sbox[0][3][count], SBox::apply(ival | 0x21, S1));
  }
}
...
TEST(TestSBox, S2_ExhaustiveEnum) {
  for (uint8_t count = 0; count < 16; count++) {
    ...
    EXPECT_EQ(Sbox[1][1][count], SBox::apply(ival | 0x01, S2));
    EXPECT_EQ(Sbox[1][2][count], SBox::apply(ival | 0x20, S2));
    EXPECT_EQ(Sbox[1][3][count], SBox::apply(ival | 0x21, S2));
  }
}
...
TEST(TestSBox, S3_ExhaustiveEnum) {
  for (uint8_t count = 0; count < 16; count++) {
    ...
    EXPECT_EQ(Sbox[2][1][count], SBox::apply(ival | 0x01, S3));
    EXPECT_EQ(Sbox[2][2][count], SBox::apply(ival | 0x20, S3));
    EXPECT_EQ(Sbox[2][3][count], SBox::apply(ival | 0x21, S3));
  }
}
...
TEST(TestSBox, S4_ExhaustiveEnum) {
  for (uint8_t count = 0; count < 16; count++) {
    ...
    EXPECT_EQ(Sbox[3][1][count], SBox::apply(ival | 0x01, S4));
    EXPECT_EQ(Sbox[3][2][count], SBox::apply(ival | 0x20, S4));
    EXPECT_EQ(Sbox[3][3][count], SBox::apply(ival | 0x21, S4));
  }
}
...
TEST(TestSBox, S5_ExhaustiveEnum) {
  for (uint8_t count = 0; count < 16; count++) {
    ...
    EXPECT_EQ(Sbox[4][1][count], SBox::apply(ival | 0x01, S5));
    EXPECT_EQ(Sbox[4][2][count], SBox::apply(ival | 0x20, S5));
    EXPECT_EQ(Sbox[4][3][count], SBox::apply(ival | 0x21, S5));
  }
}
...
TEST(TestSBox, S6_ExhaustiveEnum) {
  for (uint8_t count = 0; count < 16; count++) {
    ...
    EXPECT_EQ(Sbox[5][1][count], SBox::apply(ival | 0x01, S6));
    EXPECT_EQ(Sbox[5][2][count], SBox::apply(ival | 0x20, S6));
    EXPECT_EQ(Sbox[5][3][count], SBox::apply(ival | 0x21, S6));
  }
}
...
TEST(TestSBox, S7_ExhaustiveEnum) {
  for (uint8_t count = 0; count < 16; count++) {
    ...
    EXPECT_EQ(Sbox[6][1][count], SBox::apply(ival | 0x01, S7));
    EXPECT_EQ(Sbox[6][2][count], SBox::apply(ival | 0x20, S7));
    EXPECT_EQ(Sbox[6][3][count], SBox::apply(ival | 0x21, S7));
  }
}
